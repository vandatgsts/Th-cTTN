package com.pnt.tradix_app.adapter

import android.view.LayoutInflater
import android.view.View
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.pnt.tradix_app.R
import com.pnt.tradix_app.`object`.Item

private const val ITEM_TYPE_ONE: Int = 1
private const val ITEM_TYPE_TWO: Int = 2
private const val ITEM_TYPE_THREE: Int = 3

class MenuAdapter(var listItem: ArrayList<Item>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
